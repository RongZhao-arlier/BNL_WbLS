...
int main(int argc, char** argv){
  ...
  TString outpdf=("./npedecayandmuon.pdf");
  TString outpdf_start=("./npedecayandmuon.pdf[");
  TString outpdf_end=("./npedecayandmuon.pdf]");
   TFile *outrootnpe =new TFile("PMTnpedata.root","recreate");
outrootnpe->cd();
  TTree *npetreedata=new TTree("Treenpedata","PMT npe data tree");
  TTree *npetreedata1010=new TTree("Treenpedata1010","PMT npe data tree1010");
  TTree *npetreedata1001=new TTree("Treenpedata1001","PMT npe data tree1001");
  TTree *npetreedata0110=new TTree("Treenpedata0110","PMT npe data tree0110");
  TTree *npetreedata0101=new TTree("Treenpedata0101","PMT npe data tree0101");
  TTree *npetreedata1110=new TTree("Treenpedata1110","PMT npe data tree1110");
  TTree *npetreedata1101=new TTree("Treenpedata1101","PMT npe data tree1101");
  TTree *npetreedata0111=new TTree("Treenpedata0111","PMT npe data tree0111");
  TTree *npetreedata1011=new TTree("Treenpedata1011","PMT npe data tree1011");
  TTree *npetreedata1111=new TTree("Treenpedata1111","PMT npe data tree1111");
  TTree *npetreedatah5=new TTree("Treenpedatah5","PMT npe data treeh5");
  TTree *npetreedatah4=new TTree("Treenpedatah4","PMT npe data treeh4");
  TTree *npetreedatanh45=new TTree("Treenpedatanh45","PMT npe data treenh45"); //hodo only
    // ----------------------------------------------------
...
double pmtdatanpe[pmtnb];
double pmtdatanpedecay[pmtnb];
double pmtcf[pmtnb]={.934,.7,0.498,0.87,.92,1.05,1.07,.91};
npetreedata->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata->Branch("pmtdatanpedecay", &pmtdatanpedecay, "pmtdatanpedecay[8]/D");
npetreedata->Branch("thistriggerflag", &thistriggerflag, "thistriggerflag/I");
npetreedata1010->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata1001->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata0110->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata0101->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata1110->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata1101->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata0111->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata1011->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedata1111->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedatah5->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedatah4->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
npetreedatanh45->Branch("pmtdatanpes", &pmtdatanpe, "pmtdatanpe[8]/D");
Float_t pmtdatathreshold=1,pmtdatanpemax=0,npediff=0,avenpe=0,npes0=0,npes1=0,npes2=0,npes3=0;
Float_t rs2s1=1,rs3s0=1;
npetreedata->Branch("pmtdatathreshold", &pmtdatathreshold, "pmtdatathreshold/F");
npetreedata->Branch("pmtdatanpediff", &npediff, "npediff/F");
npetreedata->Branch("pmtdataavenpe", &avenpe, "avenpe/F");
npetreedata->Branch("pmtdatars2s1", &rs2s1, "rs2s1/F");
npetreedata->Branch("pmtdatars3s0", &rs3s0, "rs3s0/F");
npetreedata->Branch("pmtdatas0", &npes0, "npes0/F");
npetreedata->Branch("pmtdatas1", &npes1, "npes1/F");
npetreedata->Branch("pmtdatas2", &npes2, "npes2/F");
npetreedata->Branch("pmtdatas3", &npes3, "npes3/F");
   ...
   // the mean values of the muon time between PMTs. since I have 28 groups between PMTs, the upper part I use -100 to indicate not used.
    ...
    char dirnames[100];
//*****here to ceate the output ROOT directories
    ...
    TH1F* hDigiSTtrigger[pmtnb];  // start time bin of the first pulse
    TH2F* hDigiSTnpe[pmtnb];
    TH2F* hDiginpe_tb=new TH2F("toppmt_bottompmt_npe","t_bnpe",50,0,4,50,0,4);    
//    TH2F* hDiginpe_tb=new TH2F("toppmt_bottompmt_npe","t_bnpe",50,0,50,50,0,50);    
    TH2F* hDigitime_tb=new TH2F("toppmt_bottompmt_time","t_time",100,0,2500,100,0,2500);    
    TH2F* hDigiaveragetime_tb;  
    TH2F* hDigiSTs45=new TH2F("st45","st45",400,0,400,400,0,400);  // start time bin of the first pulse
    ...
    TH1F* hcoincidence_npe[pmtnb]; // the histogram of npe for coincidence events.
    ...
    TH2F* hDecayChargeVsMuonCharge[nbTrig]; // the 2D histogram of total charge from decay electron pulses vs. the muon charge
    TH2F* hDecayChargeVsMuonCharge_all; // the 2D histogram of total charge from decay electron pulses vs. the muon charge
    ...
    for(int i=0;i<pmtnb;i++){
        ...
        sprintf(tempname,"hcoincidence_npe_PMTS%d",i);
        hcoincidence_npe[i] = new TH1F(tempname,"",80,0,20);
        hcoincidence_npe[i]->SetXTitle("coincidence_npe");
        hcoincidence_npe[i]->SetYTitle("Counts");
        ...
        for(int j=0;j<nbTrig;j++){
            ...
            //if(i==0){
              ...
              sprintf(tempname,"hTimeDiffaa_%s",sTriggerType[j].c_str());
              ...
              sprintf(tempname,"hChargeVsmuon_decay_%s",sTriggerType[j].c_str());
              hDecayChargeVsMuonCharge[j] = new TH2F(tempname,"",200,0,200,200,0,200);
              hDecayChargeVsMuonCharge[j]->SetXTitle("muon total charge");
              hDecayChargeVsMuonCharge[j]->SetYTitle("Total decay charge in all PMTs (npe)");
              sprintf(tempname,"hChargeVsmuon_decay_%sall",sTriggerType[j].c_str());
              hDecayChargeVsMuonCharge_all = new TH2F(tempname,"",200,0,200,200,0,200);
              hDecayChargeVsMuonCharge_all->SetXTitle("muon total charge");
              hDecayChargeVsMuonCharge_all->SetYTitle("Total decay charge in all PMTs (npe)");
		...
		if(j==0){
                sprintf(tempname,"hStartTimetrigger_%s",sDigiChMap[i].c_str());
                hDigiSTtrigger[i] = new TH1F(tempname,"",2560,0,2560);
                hDigiSTtrigger[i]->SetXTitle("Time bin number");
                hDigiSTtrigger[i]->SetYTitle("Counts");
                sprintf(tempname,"hStartTimenpe_%s",sDigiChMap[i].c_str());
                hDigiSTnpe[i] = new TH2F(tempname,"",2560,0,2560,200,0,40);
                hDigiSTnpe[i]->SetXTitle("Time bin number");
                hDigiSTnpe[i]->SetYTitle("NPE");
		}
    ...
    */
    for(int i=0; i<8; i++){
        ...
        hTimeDiff_PMTs_hodoTrig[i]=new TH1F(name,name,150,50,200);
        hTimeDiff_PMTs_hodoTrig[i]->SetXTitle("Time difference between PMT and hodoTrig in ns");
    ...
    for(int i=0;i<pmtnb;i++){
        for(int j=0;j<nbTrig;j++){
            ...
            hCharge1[i][j] = new TH1F(tempname,"",50,0,50);  //rong modified from 50 to 1
	...
	for(int i=0; i<input_runNumberBegin.size();i++){
        ...
        for(int i=0;i<nentries;i++){ // begin to read events in one ROOT tree
            ...
            bool ismultitrig = false;  //rong zhao
            trigcnts_all++;
            int newtrigtype = 0;
            ...
            if( evtTDC[6]!=-1){ // hodoscope triggers
//            if( evtTDC[2]==-1 && evtTDC[0]!=-1 && evtTDC[3]!=-1 && evtTDC[1]!=-1){ // hodoscope triggers
//            if(evtTDC[6]!=-1 && evtTDC[2]==-1 && evtTDC[0]!=-1 && evtTDC[3]!=-1 && evtTDC[1]!=-1){ // hodoscope triggers
		...
		if(evtTDC[2]!=-1 && evtTDC[4]!=-1) hTDC_H4H2->Fill(evtTDC[4]-evtTDC[2]);
           ...
           // event rate vs. run time, at the last event, get average event rate for the three trigger types
            ...
            double thispmt_charge[pmtnb], thispmt_charge_50ns[pmtnb],thispmt_charge_decay[pmtnb];
	    double toppmtnpe=0; int ntoppulse=0;
	    double bottompmtnpe=0; int nbottompulse=0;
	    double topaveragetime=0;
	    double bottomaveragetime=0;
	    double timet_bdifference=0;
            double tmptimetdc[pmtnb];
            for(int t=0; t<pmtnb; t++){ thispmt_charge[t]=0; thispmt_charge_50ns[t]=0;thispmt_charge_decay[t]=0;}
            ...
            for(int k=0;k<pmtnb;k++){ // begin looping through pmts
             ...
             for(int trig=0; trig<nbTrig; trig++){
              ...
              for(int pulsecnt=0; pulsecnt<evtDigitizerNumberOfPulses[k]; pulsecnt++){
                  ...
                  if(isledtrig==true){ledtrig_pmtcharge += -1.0*evtDigitizerPulseCharge[k][pulsecnt]/converterfactor[k];} //rong zhao
...
//                ||(isledtrig==true)  //rong zhao, remove the led events
		) continue;
		...
		//rong,calculate the late light charge
		if((pulseTimeInPMTs[k][pulsecnt]-t_firstpulse) >50){thispmt_charge_decay[k]+=pulseChargeInPMTs[k][pulsecnt];}
                 //cout<<k<<"\t"<<pulsecnt<<"\t"<<pulseTimeInPMTs[k][pulsecnt]<<"\t"<<meanPulseStartBin[k]<<endl;
                 if(pulsecnt>=0){   //rong modified to count hit time of all photons
//                 if(pulsecnt==0){ 
                     t_firstpulse = pulseTimeInPMTs[k][pulsecnt];
                     //cout << "test output " << k <<"\t"<< t_firstpulse << endl;
                    hDigiSTnpe[k]->Fill(pulseTimeInPMTs[k][pulsecnt],pulseChargeInPMTs[k][pulsecnt]);
		    if(k==4||k==5){  // the top PMTs 
			if(pulseTimeInPMTs[k][pulsecnt]>0&&pulseChargeInPMTs[k][pulsecnt]<300){toppmtnpe+=pulseChargeInPMTs[k][pulsecnt]; topaveragetime+=pulseTimeInPMTs[k][pulsecnt];
			ntoppulse++;}
			}
		    else {  //the bottom PMTs
			if(pulseTimeInPMTs[k][pulsecnt]>0&&pulseChargeInPMTs[k][pulsecnt]<300){bottompmtnpe+=pulseChargeInPMTs[k][pulsecnt];bottomaveragetime+=pulseTimeInPMTs[k][pulsecnt];
			nbottompulse++;
			 }
			}
			if(k==pmtnb-1&&pulsecnt==evtDigitizerNumberOfPulses[k]-1){	
//				hDiginpe_tb->Fill(toppmtnpe,bottompmtnpe);
				topaveragetime=topaveragetime*1./ntoppulse;bottomaveragetime=bottomaveragetime*1./nbottompulse;
				timet_bdifference=topaveragetime-bottomaveragetime;
				if(ntoppulse>0&&nbottompulse>0){
					if(fabs(timet_bdifference)<100)hDigitime_tb->Fill(topaveragetime,bottomaveragetime);
					if(fabs(timet_bdifference)<100)hDiginpe_tb->Fill(toppmtnpe,bottompmtnpe);
					}
				}
                     for(int trig=0; trig<nbTrig; trig++) {
                         //if(istrigger[trig]==true) //rong modified to draw hit time of all the trig combinations
                         //if(istrigger[trig]==true)
...
//                            if(k>5) hDigiSTs45->Fill(0.,1.);//rong for calculate time of s4 and s5
                            double tmptime;
			if(evtDigitizerNumberOfPulses[k]>0&&evtTDC[6]!=-1){
                            if(k==4)tmptime=pulseTimeInPMTs[k][0];
                           if(k==5 && thispmt_charge[k-0]>=10) hDigiSTs45->Fill(tmptime,1.*pulseTimeInPMTs[k][0]);//rong for calculate time of s4 and s5
             			}
		...
		tmptimetdc[k]=newEvtDigitizerPulseStartBin[0]-evtTDC[6]*0.035;
                   if(mm==0&&evtTDC[6]!=-1&&k==7){
                     ...
                     //hDigiPulseChargeNpe_vs_PulseWidth[k][trigindex]->Fill(-1.0*newEvtDigitizerPulseCharge[mm]/converterfactor[k],newEvtDigitizerPulseEndBin[mm]-newEvtDigitizerPulseStartBin[mm]);
                     			if(thispmt_charge[4]>=10&&thispmt_charge[5]>=10){
					for(int aa=0;aa<pmtnb;aa++)
					 hTimeDiff_PMTs_hodoTrig[aa]->Fill(tmptimetdc[aa]);
						}
//					 hTimeDiff_PMTs_hodoTrig[k]->Fill(newEvtDigitizerPulseStartBin[mm]-evtTDC[6]*0.035);
        ...
        for(int trigindex=0; trigindex<nbTrig; trigindex++){
		double hee_threshold=1;
		bool hee_tag=1;
		int firedpmtcnt=0;
		for(int pmtID=0; pmtID<pmtnb; pmtID++){  //check the total photon number of each PMT>>threshold
			if(thispmt_charge_50ns[pmtID]<hee_threshold)hee_tag=0;	
			if(thispmt_charge_50ns[pmtID]>.5)firedpmtcnt++;
		}
		pmtdatathreshold=thispmt_charge_50ns[0];
		pmtdatanpemax=thispmt_charge_50ns[0];
// search the threshold that all PMTs pass it
		npediff=0;
		npes0=0;
		npes1=0;
		npes2=0;
		npes3=0;
		avenpe=0;
		for(int thi=0;thi<8;thi++){
			if(pmtdatathreshold>thispmt_charge_50ns[thi]/pmtcf[thi])pmtdatathreshold=thispmt_charge_50ns[thi]/pmtcf[thi];
			//if(pmtdatathreshold>thispmt_charge_50ns[thi])pmtdatathreshold=thispmt_charge_50ns[thi];
			if(pmtdatanpemax<thispmt_charge_50ns[thi])pmtdatanpemax=thispmt_charge_50ns[thi];
			avenpe+=thispmt_charge_50ns[thi];
		}
		rs2s1=thispmt_charge_50ns[2]/thispmt_charge_50ns[1];
		rs3s0=thispmt_charge_50ns[3]/thispmt_charge_50ns[0];
		npediff=pmtdatanpemax-pmtdatathreshold;
		npes0=thispmt_charge_50ns[0];
		npes1=thispmt_charge_50ns[1];
		npes2=thispmt_charge_50ns[2];
		npes3=thispmt_charge_50ns[3];
		avenpe=avenpe*1./8;
            for(int pmtID=0; pmtID<pmtnb; pmtID++){
			pmtdatanpe[pmtID]=-1; //rong zhao 
			pmtdatanpedecay[pmtID]=-1; //rong zhao 
//                if(ismultitrig==true&&isledtrig==false&&firedpmtcnt==6){ //rong zhao exclude the LED trig 
                  if(istrigger[trigindex]==true||isledtrig==false){ //rong zhao exclude the LED trig 
//                  if(istrigger[trigindex]==true&&isledtrig==false&&hee_tag){ //rong zhao exclude the LED trig 
                    hCharge[pmtID][trigindex]->Fill(thispmt_charge[pmtID]);
			pmtdatanpedecay[pmtID]=thispmt_charge_decay[pmtID];// rong zhao
			pmtdatanpe[pmtID]=thispmt_charge_50ns[pmtID];// rong zhao
                    //if(thispmt_charge_50ns[pmtID]>0)hCharge1[pmtID][trigindex]->Fill(thispmt_charge_50ns[pmtID]);//rong zhao add the 0cut
                    hCharge1[pmtID][trigindex]->Fill(thispmt_charge_50ns[pmtID]);//rong zhao add the 0cut
                }
		
            }
		//if(istrigger[trigindex]==true&&((trigindex+1)%3==0)){  //rong zhao modified for the decay  events
		//if(istrigger[trigindex]==true&&((trigindex+1)%3==2)){  //rong zhao modified for the H6/H5 events
		//if(istrigger[trigindex]==true&&((trigindex%3)>0)){  //rong zhao modified for the H6/H5 events
		//if(trigindex==0&&firedpmtcnt==8&&hee_tag){  //rong zhao modified for the multiplicity events
		if(istrigger[trigindex]==true){  //rong zhao modified for the H6/H5 events
		//cout<<trigindex<<endl;
    		outrootnpe->cd();
		npetreedata->Fill();	//select all hodo events
		if((trigindex-trigindex%3)/3==0&&(trigindex%3!=0))npetreedata1010->Fill();	
		if((trigindex-trigindex%3)/3==1&&(trigindex%3!=0))npetreedata1001->Fill();	
		if((trigindex-trigindex%3)/3==2&&(trigindex%3!=0))npetreedata0110->Fill();	
		if((trigindex-trigindex%3)/3==3&&(trigindex%3!=0))npetreedata0101->Fill();	
		if((trigindex-trigindex%3)/3==4&&(trigindex%3!=0))npetreedata1110->Fill();	
		if((trigindex-trigindex%3)/3==5&&(trigindex%3!=0))npetreedata1101->Fill();	
		if((trigindex-trigindex%3)/3==6&&(trigindex%3!=0))npetreedata0111->Fill();	
		if((trigindex-trigindex%3)/3==7&&(trigindex%3!=0))npetreedata1011->Fill();	
		if((trigindex-trigindex%3)/3==8&&(trigindex%3!=0))npetreedata1111->Fill();	
		if(trigindex==20)npetreedatah5->Fill();	
		if(trigindex==19)npetreedatah4->Fill();	
		if((trigindex+1)%3==1)npetreedatanh45->Fill();	
//		if((trigindex+1)%3==0)npetreedatah5->Fill();	
//		if((trigindex+1)%3==2)npetreedatah4->Fill();	
    		rtfile->cd();}
	}
            ...
            */
            ...
            for(int pmtid=0;pmtid<8;pmtid++){ // no selection, fill all pulse times (subtract muon start time in each pmt) in all pulses in all pmts
              for(int nbpulse=0; nbpulse<pulseTimeInPMTs[pmtid].size(); nbpulse++){
                ...
                if(deltaT>0&&pulseChargeInPMTs[pmtid][nbpulse]<5)hTimeDiff[index]->Fill(deltaT);
                if(deltaT>0&&pulseChargeInPMTs[pmtid][nbpulse]<5)hTimeDiff[0]->Fill(deltaT);
//                if(deltaT>0&&pulseChargeInPMTs[pmtid][nbpulse]<5)hcoincidence_npe[pmtid]->Fill(pmtdatanpe[pmtid]);
            ...
            if(mytimevector.size()>1){
              ...
              if(cntindex==2){ // there are very few events: in 50 water runs, >=2 events: 39 , >=3 events: 1, the ratio is 1/39=2.6%.
                ...
                for(int yy=0;yy<20;yy++){
		int pmtcoincidenceflag[pmtnb]={0};
                  if(mycoincidencecounting[yy]>1){
                    decayflag++;
                    ...
                    //}
                    if(decayflag==1){ //the the group of signal
			coincidencecnt[decayflag-1] = thecoincidencetime[yy].size(); //rong zhao add the mu charge
                      for(int pp=0; pp<thecoincidencetime[yy].size(); pp++){ //pulses in one coincidence group
                        electronchargemuon += thecoincidencecharge[yy][pp];
			pmtcoincidenceflag[thecoincidencepmt[yy][pp]]=1;
				}
				}
                    if(decayflag==2){
                	...
                	if(avgtime>500){
				hcoincidence_npe[thecoincidencepmt[yy][pp]]->Fill(thecoincidencecharge[yy][pp]);
				}
                      }
			for(int pc=0;pc<pmtnb;pc++){
				if(pmtcoincidenceflag[pc]==0)hcoincidence_npe[pc]->Fill(0);
				}
                      avgtime /= thecoincidencetime[yy].size();
               		if(avgtime>500)hTimeDiffSelect[0]->Fill(avgtime);
//                if(deltaT>0&&pulseChargeInPMTs[pmtid][nbpulse]<5)hcoincidence_npe[pmtid]->Fill(pmtdatanpe[pmtid]);
                    }
                  }
                }
                ...
                hDecayChargeVsMuonCharge[index]->Fill(electronchargemuon,electroncharge);
                hDecayChargeVsMuonCharge_all->Fill(electronchargemuon,electroncharge);
...
//   dirEvtTimeDiff->cd();
  ...
  can1->Print(outpdf_start);
    for(int i=0; i<pmtnb; i++){
        for(int j=0; j<nbTrig; j++){
            dir_TrigType[j]->cd();
           if(i==0)hDigitizerPulseChargeDecay[j]->Write();
           if(i==0)hDecayChargeVsMuonCharge_all->Write();
           hDecayChargeVsMuonCharge[j]->Write();
            hCharge[i][j]->Write();
            hCharge1[i][j]->Write();
  	if(i==0){
  		can1->cd();
           	hDecayChargeVsMuonCharge[j]->Draw("colz");
		gPad->SetLogz();
		can1->SaveAs(outpdf);
       	 	}
	}
  ...
  can1->Print(outpdf_end);
    ...
    for(int i=0; i<pmtnb; i++){
        for(int j=0; j<nbTrig; j++){
            dir_TrigType[j]->cd();
            hDigiPulseAmp[i][j]->Write();
           if(i==0&&j==0)hTimeDiffSelect[j]->Write();
        }
    }        

    outrootnpe->cd();
            hDiginpe_tb->Write();// the histogram for total top and bottom PMTs.
            hDigitime_tb->Write();// the histogram for total top and bottom PMTs.
    for(int i=0; i<8;i++){ 
		hcoincidence_npe[i]->SetLineWidth(2);
		hcoincidence_npe[i]->Write();
		hTimeDiff_PMTs_hodoTrig[i]->Write();
            hDigiSTnpe[i]->Write();}
            hDigiSTs45->Write();
    npetreedata->Write();
    npetreedata1010->Write();
    npetreedata1001->Write();
    npetreedata0110->Write();
    npetreedata0101->Write();
    npetreedata1110->Write();
    npetreedata1101->Write();
    npetreedata0111->Write();
    npetreedata1011->Write();
    npetreedata1111->Write();
    npetreedatah5->Write();
    npetreedatah4->Write();
    npetreedatanh45->Write();
    outrootnpe->Close();
    rtfile->Close();
    ...
    cout<<trigcnts_all<<"\t"<<trigcnts_multi<<"\t"<<trigcnts_hodo<<"\t"<<endl;
    for(int index=0; index<nbTrig; index++){
